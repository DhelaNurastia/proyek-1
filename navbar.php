<!-- navbar.php -->
<?php if (!isset($base_url)) $base_url = '/Sigma RentCar/'; ?>

<!-- Jangan letakkan link CSS di sini kalau sudah ada di file utama -->

<header id="header" class="header d-flex align-items-center fixed-top">
  <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">

    <a href="index_customer.php" class="logo d-flex align-items-center me-auto me-xl-0">

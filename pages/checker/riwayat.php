    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column">
          ...
          <li class="nav-item"><a href="riwayat.php" class="nav-link active"><i class="nav-icon fas fa-clock"></i><p>Riwayat Pemeriksaan</p></a></li>
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php if ($r['foto_pre']) { ?>
                  <img src="../../uploads/<?= $r['foto_pre'] ?>" width="100">
                <?php } else { echo '-'; } ?>
              </td>
              ...
              <td>
                <?php if ($r['foto_post']) { ?>
                  <img src="../../uploads/<?= $r['foto_post'] ?>" width="100">
                <?php } else { echo '-'; } ?>
              </td>
              <td><?= $r['catatan'] ?: '-' ?></td>

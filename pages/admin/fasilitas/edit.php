...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama)) {
        ...
        $sql = 'UPDATE fasilitas SET nama = ? WHERE id = ?';
        $stmt = $db->prepare($sql);
                ...
                <div class="container-fluid">
                    ...
                    <form method="post" class="d-flex flex-column">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" autofocus class="form-control" id="nama" name="nama" placeholder="Contoh: supir, lepas kunci, dll..." value="<?php echo $d['nama']; ?>">
                        </div>
